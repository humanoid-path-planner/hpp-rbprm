...
namespace rbprm {
namespace stability {
/// Implementation of the gift wrapping algorithm to determine the 2D projection of the convex hull of a 3D set of
/// rectangles and whether a point belongs to it or not.
///
