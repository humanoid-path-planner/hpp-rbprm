...
class ParabolaPlanner : public core::PathPlanner {
 public:
   ...
   */
  core::PathPtr_t computeRandomParabola(core::NodePtr_t x_start, core::ConfigurationPtr_t q_target,
 ...
 private:
  ...
  void computeGIWC(const core::NodePtr_t x) { computeGIWC(static_cast<core::RbprmNodePtr_t>(x)); }
